...
<html lang="en">
    <head>
        ...
        <title>Digital Twin Robot Mobil dengan 3D Models</title>
            ...
            <div class="container">
                ...
                <div class="intro row">
                    ...
                    <div class="col-sm-6 col-sm-offset-6">
                        <h2 class="header-quote">Revolusi Mobilitas</h2>
                        <p>
                            Membuka Jalan Menuju Dunia Baru yang Terhubung dan Efisien!
                        </p>
                        <h1 class="header-title">Digital Twin Robot<br><span class="thin">3D Models</span></h1>
                    </div>
                </div> <!-- /.intro.row -->
            </div> <!-- /.container -->
        ...
        <section id="product" class="product">
            <div class="container section-bg">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-box">
                            <h2 class="title">Welcome to our <span>Robot Car</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="porduct-box">
                            <img class="img-responsive" src="images/product-1.jpg" alt="product">
                ...
                <div class="row">
                    ...
                    <div class="boxed">
                        <div class="col-sm-4">
                            <p class="p-large">
                                Robot Mobil Digital Twin adalah konsep inovatif yang memungkinkan kita untuk menciptakan salinan digital real-time dari robot mobil fisik. Dengan model 3D yang presisi, kita dapat memantau, mengendalikan, dan mengoptimalkan robot mobil kita dengan cara yang belum pernah terjadi sebelumnya. Ini memungkinkan kita untuk melakukan berbagai tugas yang lebih cerdas, efisien, dan aman.
                            </p>
                        </div>
                        <div class="col-sm-4">
                            <p>
            ...
            <div class="container section-bg">
                ...
                <div class="row">
                    <div class="boxed">
                        ...
                        <div class="col-sm-12">
                            <img class="img-responsive" src="images/history.png" alt="history">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="boxed">
                       <div class="col-sm-12">
                           <div id="partner-slider" class="owl-carousel">
                                <div class="item">
                                    <img src="images/6.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="images/7.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="images/8.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="images/9.png" alt="partner">
                                </div>
                                <div class="item">
                                    <img src="images/6.png" alt="partner">
                                </div>
