                ...
                <div class="row">
                    <div class="boxed">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <img class="imgresponsive" src="images/address.png" alt="con">
                                </div>
                                <div class="col-xs-9">
                                    <h5>Address</h5>
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <img class="imgresponsive" src="images/phone.png" alt="con">
                                </div>
                                <div class="col-xs-9">
                                    <h5>Phone</h5>
                                    <p class="contact-detail">
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <img class="imgresponsive" src="images/support.png" alt="con">
                                </div>
                                <div class="col-xs-9">
                                    <h5>Support</h5>
                                    <p class="contact-detail">
